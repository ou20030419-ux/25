...
def _sample_inventory() -> pd.DataFrame:
    return pd.DataFrame(
        [
            ["海盐薯片 60g", "2026-02-21", 24, 21, 3, "袋", 75, 180, "", "A-01", "仓库-1层", "6900000000012", "膨化"],
            ["芝士饼干", "2026-02-13", 134, 14, 120, "盒", 58, 300, "", "B-02", "仓库-2层", "6900000000029", "饼干"],
            ["芒果软糖", "2026-04-14", 26, 0, 26, "袋", 8, 180, "", "C-03", "仓库-1层", "6900000000036", "糖果"],
            ["酸奶小蛋糕", "2026-05-21", 38, 28, 10, "个", 96, 7, "", "D-01", "冷藏仓", "6900000000043", "糕点"],
            ["酸奶小蛋糕", "2026-05-19", 36, 28, 8, "个", 96, 30, "", "D-01", "冷藏仓", "6900000000043", "糕点"],
            ["坚果能量棒", "2026-05-24", 16, 14, 2, "根", 60, 180, "", "E-02", "仓库-3层", "6900000000050", "坚果"],
        ],
